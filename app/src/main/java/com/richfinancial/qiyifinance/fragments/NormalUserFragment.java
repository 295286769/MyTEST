 ...
 */
public class NormalUserFragment extends BaseFragment {
    ...
    public void initView() {
        ...
        mList.add(hb3);
        mList.add(hb4);
        mAdapter = new NormalUserAdapter(getActivity(), mList);
...
//                        mRecyclerView.setAdapter(mAdapter);
        ...
        mAdapter.setOnItemClickListener(new NormalUserAdapter.OnRecyclerViewItemClickListener(){
               @Override
                   ...
                   bundle.putString("fragmentName","NormalUserFragment");
