...
public class AddProjectAty extends BaseActivity implements View.OnClickListener {
    ...
    protected void initContentView(Bundle savedInstanceState) {
        ...
        switch (getIntent().getIntExtra("type" , -1)){
            case PROJECT:
                txtv_title.setText(getString(R.string.str_txtv_project_add));
                break;

            case DEPARTMENT:
                txtv_title.setText(getString(R.string.str_txtv_department_add));
                break;
        }
