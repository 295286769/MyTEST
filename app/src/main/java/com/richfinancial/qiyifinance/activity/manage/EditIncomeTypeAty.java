...
public class EditIncomeTypeAty extends BaseActivity implements View.OnClickListener {
     ...
     * 删除按钮
     * */
    private TextView txtv_delete_incometype;



    @Override
    protected void initContentView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_edit_incometype);
        ...
        txtv_delete_incometype = (TextView)findViewById(R.id.txtv_delete_incometype);

        switch (getIntent().getIntExtra("type" , -1)){
            case INCOME_TYPE:
                txtv_title.setText(getString(R.string.str_txtv_incometype_edit));
                break;

            case EXPEND_TYPE:
                txtv_title.setText(getString(R.string.str_txtv_expendtype_edit));
                break;
        }
        imgbtn_left.setOnClickListener(this);
        imgbtn_right.setOnClickListener(this);
        txtv_delete_incometype.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.imgbtn_right:
                ...
                break;
            case R.id.txtv_delete_incometype:
                Toast.makeText(this, "删除", Toast.LENGTH_SHORT).show();
                break;

            case R.id.rl_oper:
                Intent intent = new Intent(EditIncomeTypeAty.this , SelectNodeActivity.class);
