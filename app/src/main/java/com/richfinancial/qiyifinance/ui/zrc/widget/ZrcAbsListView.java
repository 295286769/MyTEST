package com.richfinancial.qiyifinance.ui.zrc.widget;
...
import com.richfinancial.qiyifinance.ui.zrc.widget.ZrcListView.OnItemLongClickListener;
import com.richfinancial.qiyifinance.ui.zrc.widget.ZrcListView.OnScrollListener;
import com.richfinancial.qiyifinance.ui.zrc.widget.ZrcListView.OnScrollStateListener;
import com.richfinancial.qiyifinance.ui.zrc.widget.ZrcListView.OnStartListener;
...
public abstract class ZrcAbsListView extends ZrcAdapterView<ListAdapter>
	...
	private class FlingRunnable implements Runnable {
		...
		boolean scrollToAdjustViewsUpOrDown() {
			...
			if ((isRefreshing || isLoadingMore) && mZrcFooter != null) {
				lastBottom += mZrcFooter.getHeight();
			}
			final Rect listPadding = mListPadding;
			final Headable zrcHeader = mZrcHeader;
