 ...
 * SharePreferenceUtil
 * 项目名称:  QYManager
 * 类描述:    SharePreference管理工具
 * 创建人:    luqb
 * 创建时间:  2016-03-09
 * 修改人:    luqb
 * 修改时间:  2016-03-09
 * 修改备注:  SharePreference管理工具
 * 版本:      v1.0
 */
public class SharePreferenceUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "xzbapp_data";
    /** 用户名 */
    ...
    /** 存储需要上传图片jsong串 */
    public static final String UPDATA_PIC = "updata_pic";
    /** 保存合同版本号 */
    ...
    /** 最近选择城市*/
    public static final String KEY_RECENT_CITY = "key_recent_city";
