 ...
 * 版本:      v1.0
 */
public class DeleteUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    public DeleteUserAdapter(Context context, List<NormalUserBean> list) {
